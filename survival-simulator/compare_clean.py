...
from src.utils.controllers.evohive_policy import action_decision as v1
from src.utils.controllers.evohive_v11_policy import action_decision as v11
...
r1 = benchmark("EVOHIVE_V1", v1)
r11 = benchmark("EVOHIVE_V11", v11)

print("\\n===== PER-SEED CHANGE V1.1 - V1 =====")
