...
from src.utils.controllers.evohive_v7_forager import action_decision as v7
...
dt = [b[0] - a[0] for a, b in zip(v2r, v7r)]
ds = [b[1] - a[1] for a, b in zip(v2r, v7r)]
