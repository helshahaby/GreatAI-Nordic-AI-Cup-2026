...
MODEL_PATH = (
    ...
    / "runs/detect/runs/flysight/yolo11n_camera_v1/weights/best.pt"
)

logger.info("Loading FlySight YOLO model from %s", MODEL_PATH)

_model = YOLO(str(MODEL_PATH))

# Start permissively. We can tune this using actual evaluator mAP.
